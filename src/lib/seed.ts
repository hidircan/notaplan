...
export function createSeedData(): AppData {
  ...
  const teachers = [
    {
      ...
      instruments: ["Piyano","Gitar","Elektro Gitar","Şan","Yan Flüt"] as Instrument[],
      availability: [
    ...
    },
    {
      ...
      phone: "0535 262 06 23",
      branchId: "erzene" as BranchId,
      instruments: ["Bağlama","Gitar","Elektro Gitar","Piyano","Şan"] as Instrument[],
      availability: [
    ...
    },
    {
      ...
      phone: "0 507 361 78 90",
      branchId: "evka3" as BranchId,
      instruments: ["Keman","Piyano","Şan"] as Instrument[],
      availability: [
    ...
    },
    {
      ...
      phone: "0 507 836 72 81",
      branchId: "evka3" as BranchId,
      instruments: ["Piyano","Şan","Yan Flüt"] as Instrument[],
      availability: [
    ...
    },
    {
      ...
      phone: "0 507 940 47 88",
      branchId: "erzene" as BranchId,
      instruments: ["Keman","Piyano"] as Instrument[],
      availability: [
        { dayOfWeek: 2, start: "14:00", end: "21:00" },
        { dayOfWeek: 3, start: "14:00", end: "21:00" },
        { dayOfWeek: 4, start: "14:00", end: "21:00" },
    ...
    },
    {
      ...
      phone: "0 554 461 69 11",
      branchId: "erzene" as BranchId,
      instruments: ["Piyano","Keman"] as Instrument[],
      availability: [
        { dayOfWeek: 2, start: "14:00", end: "21:00" },
        { dayOfWeek: 3, start: "14:00", end: "21:00" },
        { dayOfWeek: 4, start: "14:00", end: "21:00" },
  ...
  const students = [
    ...
    },
    {
      id: "s4",
      name: "Hıdırcan Yağız",
      email: "hıdır.can.yağız@niluferacar.com.tr",
      phone: "0533 618 50 06",
      parentName: "Ezgi Yağız",
      parentPhone: "05322439641",
      branchId: "erzene" as BranchId,
      instruments: ["Bağlama"] as Instrument[],
      teacherId: "t2",
      packageName: "Bireysel Aylık — 4 ders",
      weeklyLessonCount: 1,
      monthlyFee: 2400,
  ...
  const lessonDefs: LDef[] = [
    ...
    { id: "l4", studentId: "s4", teacherId: "t2", roomId: "r6", branchId: "evka3", instrument: "Bağlama", day: -4, hour: 17, status: "cancelled" },
    ...
    { id: "l11", studentId: "s4", teacherId: "t2", roomId: "r6", branchId: "evka3", instrument: "Bağlama", day: 0, hour: 18 },
    ...
    { id: "l19", studentId: "s4", teacherId: "t2", roomId: "r6", branchId: "evka3", instrument: "Bağlama", day: 5, hour: 17 },
  ...
  const makeupRequests = [
    ...
    },
    {
      ...
      teacherId: "t2",
      branchId: "evka3" as BranchId,
      instrument: "Bağlama" as Instrument,
      sourceLessonId: "l4",
      attendanceId: "a4",
      status: "pending" as const,
